...
# the demo_pb2.py basically contains the generated python data / message classes to interact with cartitem , product , money , address, Chargerequest, Placeorderresponse, etc.
# and the service classes to interact with cartservice, recommendationservice, productcatalogservice, shippingservice, currencyservice, paymentservice, emailservice,
