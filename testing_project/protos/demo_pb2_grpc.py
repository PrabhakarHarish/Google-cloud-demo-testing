...
# this file basically contains the extracted code from the micro services source code line by line .
# So It is automatically generated from the service contract in the demo.proto file and is used to create the gRPC server and client stubs for the microservices.
# It defines the service interfaces, request and response message types, and the methods that can be called on each service.
# The generated code allows developers to implement the service logic and handle incoming requests in a structured way.